...
for d=1:length(subjects)
    ...
    switch TestType
        case 1
            textscale = -.1;
            if SRType == 1
                tickMarks=[20 30:5:80]; xlimit=[17.5 82.5]; ylimit=[-.4 .4]; Toffset=1;
                xticklabs={'No Noise' '30' '35' '40' '45' '50' '55' '60' '65' '70' '75' '80'};
            elseif SRType == 2
                tickMarks=[-.1 .1:.1:1]; xlimit=[-.3 1.2]; ylimit=[-.4 .4]; Toffset=.025;
                xticklabs={'No Noise' '.1' '.2' '.3' '.4' '.5' '.6' '.7' '.8' '.9' '1'};
            end
        case 2
            textscale = -8;
            if SRType == 1
                tickMarks=[-15 -5:5:40]; xlimit=[-20 45]; ylimit=[-12.5 17.5]; Toffset=1;
                xticklabs={'No Noise' '-5' '0' '5' '10' '15' '20' '25' '30' '35' '40'};
            elseif SRType == 2
                tickMarks=[-.1 .1:.1:1]; xlimit=[-.3 1.2]; ylimit=[-12.5 17.5]; Toffset=.025;
                xticklabs={'No Noise' '.1' '.2' '.3' '.4' '.5' '.6' '.7' '.8' '.9' '1'};
            end
        case 3
            textscale = -.1;
            if SRType == 1
                ...
                xticklabs={'No Noise' '30' '35' '40' '45' '50' '55' '60' '65' '70' '75' '80'};
            elseif SRType == 2
                tickMarks=[-.1 .1:.1:1]; xlimit=[-.3 1.2]; ylimit=[-.5 .5]; Toffset=.025;
                xticklabs={'No Noise' '.1' '.2' '.3' '.4' '.5' '.6' '.7' '.8' '.9' '1'};
            end
        case 4
            textscale = -.1;
    ...
    plot(level_vect,mubi_vect-mubi_vect(1),['*' colors(d)],'LineWidth',1.1)
    plot(level_vect(1),0,['*k'],'LineWidth',1.1)
    hold on
    plot(level_vect(2:end),mubi_vect(2:end)-mubi_vect(1),['--' colors(d)])
    plot(level_vect(2:end),shamline_bi-mubi_vect(1),['--k'],'LineWidth',1.05)
    h1(d)=errorbar(level_vect,mubi_vect-mubi_vect(1),mubi_jack_vect*1.96,colors(d));
...
xlabel(xTitle); ylabel(yTitle); title(['Pilot Subjects' PlotTitle ' Binary, Jack'])
