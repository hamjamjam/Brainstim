...
K = 6; %Number of data points per subject at each SR stim level 
...
if L==1
    mu_vect(1,n)=(1+A(2))*globalmu;
elseif L==2
    mu_vect(1,n)=(1+A(3))*globalmu;
elseif L==3
    mu_vect(1,n)=(1+A(4))*globalmu;
elseif L==4
    mu_vect(1,n)=(1+A(5))*globalmu;
elseif L==5
    mu_vect(1,n)=(1+A(6))*globalmu;
else
end
...
%%
subplot(3,2,M)
plot(q2,mu_underlying,'r',q,mu_bi_vect,'-o')
grid minor
M
title(num2str(M))
